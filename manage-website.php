	...
	<div class="container" style="margin-top: 80px;">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-4 col-lg-4">
				<div class="bordify">
					<h4>Add New Rule</h4>
					<h4><small>Adding a new rule here will affect what the people accessing the site will see.</small></h4>
					<button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add New Rule</button>
				</div>
			</div>
		</div>
